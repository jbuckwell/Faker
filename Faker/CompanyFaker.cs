...
namespace Faker
{
	public static class CompanyFaker
	{
		...
		{
			var suffix = ArrayFaker.SelectFrom(
				"Inc", "and Sons", "LLC", "Group"
			);

			return NameFaker.LastName() + " " + suffix;
		}
		...
		{
			var phrase1 = ArrayFaker.SelectFrom(
			...
			var phrase2 = ArrayFaker.SelectFrom( 
			...
			var phrase3 = ArrayFaker.SelectFrom( 
